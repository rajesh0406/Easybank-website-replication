...
import dintro from './images/bg-intro-desktop.svg';
import mintro from './images/bg-intro-mobile.svg';
...
function App() {
  ...
  return (
    <div className="App bg-white h-screen w-screen overflow-x-hidden">
      ...
      <section className="w-full flex flex-col md:flex-row justify-between items-center bg-darkblue py-16 px-48">
